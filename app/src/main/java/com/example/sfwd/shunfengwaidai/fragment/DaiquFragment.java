...
public class DaiquFragment extends Fragment {
    private View view;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (view != null) {
            ...
            view = inflater.inflate(R.layout.fragment_daiqu, container, false);
            initView();
        }
        //initView();
        return view;
...
//        cancel = (Button) view.findViewById(R.id.buCancel);
        ...
        edit_Daiqu = (EditText)view.findViewById(R.id.edit_Daiqu);
        edit_texttime =(EditText)view.findViewById(R.id.edit_texttime);
        daiqu_money=(EditText)view.findViewById(R.id.daiqu_money);
        daiqu_fadanB=(Button)view.findViewById(R.id.daiqu_fadanB);
        button2_daiqu=(Button)view.findViewById(R.id.button2_daiqu);
